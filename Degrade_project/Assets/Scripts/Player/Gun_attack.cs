...
public class Gun_attack : MonoBehaviour
{
    ...
    float cameraRotationValueForGun;
    ...
    void Update()
    {
        ...
        // 计算鼠标相对于修正后屏幕中心的方向向量
        Vector3 directionToMouse = new Vector3(mouseScreenPosition.x, mouseScreenPosition.y, 0f) - screenCenter;
        ...
        cameraRotationValueForGun = Camera.main.transform.rotation.eulerAngles.z;
        ...
        //     // 将当前武器的旋转角度传给子弹
        //     temp.GetComponent<Bullet>().SetDirection(angle + cameraRotationValueForGun);
        //     //temp.GetComponent<Bullet_projectile>().SetDirection(angle - 90);
        // }
    }
