...
Shader "/_Vefects_/SH_Vefects_Extra_Particles_HDRP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 temp_output_36_0 = (packedInput.ase_color).rgb;
				float3 temp_cast_0 = (packedInput.ase_texcoord1.z).xxx;
				float3 temp_cast_1 = (( packedInput.ase_texcoord1.z + _ErosionSmoothness )).xxx;
				float2 uv_ParticleTexture = packedInput.ase_texcoord2.xy * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
				...
				surfaceDescription.Color = lerpResult38;
				surfaceDescription.Emission = ( lerpResult38 * _EmissiveIntensity );
				surfaceDescription.Alpha = saturate( ( temp_output_33_0 * packedInput.ase_color.a ) ).x;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 temp_cast_0 = (packedInput.ase_texcoord.z).xxx;
				float3 temp_cast_1 = (( packedInput.ase_texcoord.z + _ErosionSmoothness )).xxx;
				float2 uv_ParticleTexture = packedInput.ase_texcoord1.xy * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
				float3 smoothstepResult27 = smoothstep( temp_cast_0 , temp_cast_1 , tex2D( _ParticleTexture, uv_ParticleTexture ).rgb);
				float3 temp_output_33_0 = saturate( smoothstepResult27 );
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 temp_output_36_0 = (packedInput.ase_color).rgb;
				float3 temp_cast_0 = (packedInput.ase_texcoord2.z).xxx;
				float3 temp_cast_1 = (( packedInput.ase_texcoord2.z + _ErosionSmoothness )).xxx;
				float2 uv_ParticleTexture = packedInput.ase_texcoord3.xy * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
				float3 smoothstepResult27 = smoothstep( temp_cast_0 , temp_cast_1 , tex2D( _ParticleTexture, uv_ParticleTexture ).rgb);
				float3 temp_output_33_0 = saturate( smoothstepResult27 );
				float3 lerpResult38 = lerp( temp_output_36_0 , ( temp_output_33_0 * temp_output_36_0 ) , _TextureLerp);
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float3 temp_cast_0 = (packedInput.ase_texcoord3.z).xxx;
				float3 temp_cast_1 = (( packedInput.ase_texcoord3.z + _ErosionSmoothness )).xxx;
				float2 uv_ParticleTexture = packedInput.ase_texcoord4.xy * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
				float3 smoothstepResult27 = smoothstep( temp_cast_0 , temp_cast_1 , tex2D( _ParticleTexture, uv_ParticleTexture ).rgb);
				float3 temp_output_33_0 = saturate( smoothstepResult27 );
...
ASEEND*/
//CHKSM=689E1D95BE7FA1E31468F3FB6D2E2760AA7842AA